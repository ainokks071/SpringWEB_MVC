...
/*
 	...
 	* 2. pom.xml에 mybatis API 작성 -> import org.apache.ibatis.annotations.Mapper; @Mapper어노테이션 사용가능
 	* 3. root-context.xml에 <mybatis:scan base-package="kr.inflearn.mapper" /> 로 @Mapper 최종적으로 스캔.
